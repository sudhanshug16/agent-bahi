...
- **[T-007: Advance-tax estimated-amount input](tentative-decisions.md#entry-t-007-advance-tax-estimated-amount-input%E2%80%94manual-entry-or-auto-projection)**: How does system capture advance-tax estimated amount? → Tentative default: capture operator input with provenance; no auto-projection or tax liability computation from input alone.
...
- **[T-009: Form 140/141 statutory export—research-gated, fail-closed](tentative-decisions.md#entry-t-009-form-140141-statutory-export%E2%80%94research-gated-fail-closed)**: Should agent-bahi export Form 140/141, or defer until official utility/schema/portal flow verified? → Tentative default: fail-closed; internal data only until research closes.
- **[T-010: Post-filing return case/evidence/correction](tentative-decisions.md#entry-t-010-post-filing-return-caseevidence-correction%E2%80%94research-gated-submission)**: How to handle post-filing return corrections or disputes? → Tentative default: preserve case details and correction lineage; no submission adapter until s263(5)-(7) branches and procedures researched.
