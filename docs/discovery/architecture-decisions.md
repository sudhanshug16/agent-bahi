...
- **Recommendation**: Fixed assets are a separate module (future Phase) with asset lifecycle, configurable book/tax depreciation schedules, depreciation runs, and traceable journals. Exact statutory methods (WDV, SLM, etc.) and book-vs-tax differences remain **OPEN RESEARCH**.
