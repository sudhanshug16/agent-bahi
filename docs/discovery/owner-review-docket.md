...
| PT-013 | ITR-Specific Portal States/Evidence; No Universal ARN | Exactly five current official ITD labels (SUBMITTED, VERIFIED, PROCESSED, DEFECTIVE, INVALID), each bound to filing-specific evidence; internal lifecycle stays separate | Phase 7 (Compliance) | [Personal Tax Packet § PT-013](personal-tax-scope.md#pt-013) |
