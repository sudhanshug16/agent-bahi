...
export function sqliteCatalogMatches(actual: readonly SqliteCatalogRow[], expected: readonly SqliteCatalogRow[]): boolean {
  ...
  const itrNames = new Set([
    ...
    "gst_return_schema_packs", "gst_return_schema_pack_events", "gst_gstr1_artifacts", "gst_gstr1_validation_runs", "gst_gstr1_export_activities",
    "uq_gst_return_schema_packs_hash", "uq_gst_return_schema_packs_identity", "idx_gst_return_schema_packs_applicable", "uq_gst_return_schema_pack_events_request", "idx_gst_return_schema_pack_events_pack",
    "uq_gst_gstr1_artifacts_id_scope", "uq_gst_gstr1_artifacts_scope_hash", "uq_gst_gstr1_artifacts_request", "idx_gst_gstr1_artifacts_scope_period", "uq_gst_gstr1_validation_runs_request", "idx_gst_gstr1_validation_runs_artifact", "uq_gst_gstr1_export_activities_request", "idx_gst_gstr1_export_activities_artifact",
    "gst_return_schema_packs_no_update", "gst_return_schema_packs_no_delete", "gst_return_schema_pack_events_no_update", "gst_return_schema_pack_events_no_delete", "gst_gstr1_artifacts_no_update", "gst_gstr1_artifacts_no_delete", "gst_gstr1_validation_runs_no_update", "gst_gstr1_validation_runs_no_delete", "gst_gstr1_export_activities_no_update", "gst_gstr1_export_activities_no_delete",
    "gst_gstr3b_schema_packs", "gst_gstr3b_schema_pack_events", "gst_gstr3b_facts", "gst_gstr3b_fact_events", "gst_gstr3b_artifacts", "gst_gstr3b_validation_runs", "gst_gstr3b_export_activities",
    "uq_gst_gstr3b_schema_packs_hash", "uq_gst_gstr3b_schema_packs_identity", "idx_gst_gstr3b_schema_packs_applicable", "uq_gst_gstr3b_schema_pack_events_request", "idx_gst_gstr3b_schema_pack_events_pack", "uq_gst_gstr3b_facts_scope_hash", "uq_gst_gstr3b_facts_request", "uq_gst_gstr3b_facts_id_scope", "idx_gst_gstr3b_facts_scope_period", "uq_gst_gstr3b_fact_events_request", "idx_gst_gstr3b_fact_events_fact", "uq_gst_gstr3b_artifacts_scope_hash", "uq_gst_gstr3b_artifacts_request", "uq_gst_gstr3b_artifacts_id_scope", "idx_gst_gstr3b_artifacts_scope_period", "uq_gst_gstr3b_validation_runs_request", "idx_gst_gstr3b_validation_runs_artifact", "uq_gst_gstr3b_export_activities_request", "idx_gst_gstr3b_export_activities_artifact",
    "gst_gstr3b_schema_packs_no_update", "gst_gstr3b_schema_packs_no_delete", "gst_gstr3b_schema_pack_events_no_update", "gst_gstr3b_schema_pack_events_no_delete", "gst_gstr3b_facts_no_update", "gst_gstr3b_facts_no_delete", "gst_gstr3b_fact_events_no_update", "gst_gstr3b_fact_events_no_delete", "gst_gstr3b_artifacts_no_update", "gst_gstr3b_artifacts_no_delete", "gst_gstr3b_validation_runs_no_update", "gst_gstr3b_validation_runs_no_delete", "gst_gstr3b_export_activities_no_update", "gst_gstr3b_export_activities_no_delete",
    "withholding_statement_schema_packs", "withholding_statement_schema_pack_events", "withholding_statement_facts", "withholding_statement_fact_events", "withholding_statement_artifacts", "withholding_statement_validation_runs", "withholding_statement_export_activities",
    "uq_withholding_statement_schema_packs_hash", "uq_withholding_statement_schema_packs_identity", "idx_withholding_statement_schema_packs_applicable", "uq_withholding_statement_schema_pack_events_request", "idx_withholding_statement_schema_pack_events_pack", "uq_withholding_statement_facts_scope_hash", "uq_withholding_statement_facts_request", "idx_withholding_statement_facts_scope_period", "uq_withholding_statement_facts_id_scope", "uq_withholding_statement_fact_events_request", "idx_withholding_statement_fact_events_fact", "uq_withholding_statement_artifacts_scope_hash", "uq_withholding_statement_artifacts_request", "uq_withholding_statement_artifacts_id_scope", "idx_withholding_statement_artifacts_scope", "uq_withholding_statement_validation_runs_request", "idx_withholding_statement_validation_runs_artifact", "uq_withholding_statement_export_activities_request", "idx_withholding_statement_export_activities_artifact",
    "withholding_statement_schema_packs_no_update", "withholding_statement_schema_packs_no_delete", "withholding_statement_schema_pack_events_no_update", "withholding_statement_schema_pack_events_no_delete", "withholding_statement_facts_no_update", "withholding_statement_facts_no_delete", "withholding_statement_fact_events_no_update", "withholding_statement_fact_events_no_delete", "withholding_statement_artifacts_no_update", "withholding_statement_artifacts_no_delete", "withholding_statement_validation_runs_no_update", "withholding_statement_validation_runs_no_delete", "withholding_statement_export_activities_no_update", "withholding_statement_export_activities_no_delete",
  ]);
  ...
  const statementSuffix = new Set([...itrNames].filter((name) => name.startsWith("withholding_statement") || name.startsWith("uq_withholding_statement") || name.startsWith("idx_withholding_statement")));
  const actualStatementSuffix = actualComparable.filter((row) => statementSuffix.has(row.name));
  const canonicalStatementSuffix = currentComparable.filter((row) => statementSuffix.has(row.name));
  if (actualStatementSuffix.length === canonicalStatementSuffix.length && compare(actualStatementSuffix, canonicalStatementSuffix)) {
    const withoutStatement = actualComparable.filter((row) => !statementSuffix.has(row.name));
    const expectedWithoutStatement = expected.filter((row) => !statementSuffix.has(row.name));
    if (sqliteCatalogMatches(withoutStatement, expectedWithoutStatement)) return true;
  }
