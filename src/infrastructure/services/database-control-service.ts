...
export class DatabaseControlService {
  ...
  private manifestForHistory(rows: readonly Record<string, unknown>[]): SqliteSchemaManifest | undefined {
    ...
    const candidates = [V2_SCHEMA_MANIFEST, V3_SCHEMA_MANIFEST, V4_SCHEMA_MANIFEST, V5_SCHEMA_MANIFEST, V6_SCHEMA_MANIFEST, V7_SCHEMA_MANIFEST, CURRENT_SCHEMA_MANIFEST];
