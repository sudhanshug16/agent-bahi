...
export const DRIZZLE_GST_MIGRATION_ID = DRIZZLE_TENANT_PAN_V1_MIGRATION_ID;
...
export const DRIZZLE_GST_HASH = DRIZZLE_TENANT_PAN_V1_HASH;
export const DRIZZLE_GST_CREATED_AT = DRIZZLE_TENANT_PAN_V1_CREATED_AT;
