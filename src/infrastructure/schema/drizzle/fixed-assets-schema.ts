...
export const assetComponents = sqliteTable("asset_components", {
  id: text("id").primaryKey(), tenantId: text("tenant_id").notNull(), bookSetId: text("book_set_id").notNull(), assetId: text("asset_id").notNull(), componentNumber: integer("component_number").notNull(), description: text("description").notNull(), costMinor: integer("cost_minor").notNull(), residualMinor: integer("residual_minor").notNull(), usefulLifeMonths: integer("useful_life_months").notNull(), method: text("method").notNull(), createdAt: text("created_at").notNull(),
}, (table) => ({
