...
const handlers: Record<string, Handler> = {
  ...
  "compliance.obligation.calendar": (facade, input) => facade.compliance.obligation.calendar(tenantId(input), bookSetId(input), text(input, "fromDate"), text(input, "toDate"), optionalText(input, "asOfDate"), { status: optionalText(input, "status") as never, code: optionalText(input, "code") }),
