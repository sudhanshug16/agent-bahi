...
const handlers: Record<string, Handler> = {
  ...
  "fiscal-year.rollover.preview": (facade, input) => facade.fiscalYearRollover.preview(tenantId(input), bookSetId(input), text(input, "financialYear")),
  "fiscal-year.rollover.finalize": (facade, input) => facade.fiscalYearRollover.finalize(input as never),
  "fiscal-year.rollover.show": (facade, input) => facade.fiscalYearRollover.show(tenantId(input), bookSetId(input), text(input, "financialYear"), text(input, "rolloverId")),
  "fiscal-year.rollover.status": (facade, input) => facade.fiscalYearRollover.status(tenantId(input), bookSetId(input), text(input, "financialYear")),
  "fiscal-year.rollover.export": (facade, input) => facade.fiscalYearRollover.export(tenantId(input), bookSetId(input), text(input, "financialYear"), text(input, "rolloverId"), text(input, "format")),
  ...
  "zoho-backup.preview": (facade, input) => facade.zohoBackup.preview(input as never),
  "zoho-backup.import": (facade, input) => facade.zohoBackup.import(input as never),
  "zoho-backup.status": (facade, input) => facade.zohoBackup.status(tenantId(input), bookSetId(input), text(input, "importId")),
  ...
  "gst.return-schema-pack.register": (facade, input) => facade.gst.gstr1Artifact.schemaPack.register(input as never),
  "gst.return-schema-pack.verify": (facade, input) => facade.gst.gstr1Artifact.schemaPack.verify(input as never),
  "gst.return-schema-pack.reject": (facade, input) => facade.gst.gstr1Artifact.schemaPack.reject(input as never),
  "gst.return-schema-pack.show": (facade, input) => facade.gst.gstr1Artifact.schemaPack.show(text(input, "packId")),
  "gst.gstr1-artifact.preview": (facade, input) => facade.gst.gstr1Artifact.artifact.preview(tenantId(input), bookSetId(input), (input.payload ?? input) as never),
  "gst.gstr1-artifact.prepare": (facade, input) => facade.gst.gstr1Artifact.artifact.prepare(input as never),
  "gst.gstr1-artifact.validate": (facade, input) => facade.gst.gstr1Artifact.artifact.validate(input as never),
  "gst.gstr1-artifact.export": (facade, input) => facade.gst.gstr1Artifact.artifact.export(input as never),
  "gst.gstr1-artifact.show": (facade, input) => facade.gst.gstr1Artifact.artifact.show(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "gst.gstr1-artifact.status": (facade, input) => facade.gst.gstr1Artifact.artifact.status(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "gst.gstr1-artifact.content": (facade, input) => facade.gst.gstr1Artifact.artifact.content(tenantId(input), bookSetId(input), text(input, "artifactId"), input.revealSensitive === true, input.actor && typeof input.actor === "object" ? String((input.actor as Record<string, unknown>).kind ?? "") : undefined),
  "gst.gstr3b-schema-pack.register": (facade, input) => facade.gst.gstr3bArtifact.schemaPack.register(input as never),
  "gst.gstr3b-schema-pack.verify": (facade, input) => facade.gst.gstr3bArtifact.schemaPack.verify(input as never),
  "gst.gstr3b-schema-pack.reject": (facade, input) => facade.gst.gstr3bArtifact.schemaPack.reject(input as never),
  "gst.gstr3b-schema-pack.show": (facade, input) => facade.gst.gstr3bArtifact.schemaPack.show(text(input, "packId")),
  "gst.gstr3b-fact.propose": (facade, input) => facade.gst.gstr3bArtifact.fact.propose(input as never),
  "gst.gstr3b-fact.confirm": (facade, input) => facade.gst.gstr3bArtifact.fact.confirm(input as never),
  "gst.gstr3b-fact.reject": (facade, input) => facade.gst.gstr3bArtifact.fact.reject(input as never),
  "gst.gstr3b-fact.list": (facade, input) => facade.gst.gstr3bArtifact.fact.list(tenantId(input), bookSetId(input)),
  "gst.gstr3b.preview": (facade, input) => facade.gst.gstr3bArtifact.artifact.preview(tenantId(input), (input.payload ?? input) as never),
  "gst.gstr3b.prepare": (facade, input) => facade.gst.gstr3bArtifact.artifact.prepare(input as never),
  "gst.gstr3b.validate": (facade, input) => facade.gst.gstr3bArtifact.artifact.validate(input as never),
  "gst.gstr3b.export": (facade, input) => facade.gst.gstr3bArtifact.artifact.export(input as never),
  "gst.gstr3b.show": (facade, input) => facade.gst.gstr3bArtifact.artifact.show(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "gst.gstr3b.status": (facade, input) => facade.gst.gstr3bArtifact.artifact.status(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "gst.gstr3b.content": (facade, input) => facade.gst.gstr3bArtifact.artifact.content(tenantId(input), bookSetId(input), text(input, "artifactId"), input.revealSensitive === true, input.actor && typeof input.actor === "object" ? String((input.actor as Record<string, unknown>).kind ?? "") : undefined),
  "mca.form-pack.register": (facade, input) => facade.mca.formPack.register(input as never),
  "mca.form-pack.verify": (facade, input) => facade.mca.formPack.verify(input as never),
  "mca.form-pack.reject": (facade, input) => facade.mca.formPack.reject(input as never),
  "mca.form-pack.show": (facade, input) => facade.mca.formPack.show(text(input, "packId")),
  "mca.fact.propose": (facade, input) => facade.mca.fact.propose(input as never),
  "mca.fact.confirm": (facade, input) => facade.mca.fact.confirm(input as never),
  "mca.fact.reject": (facade, input) => facade.mca.fact.reject(input as never),
  "mca.fact.list": (facade, input) => facade.mca.fact.list(tenantId(input), bookSetId(input)),
  "mca.annual.preview": (facade, input) => facade.mca.annual.preview(tenantId(input), (input.payload ?? input) as never),
  "mca.annual.prepare": (facade, input) => facade.mca.annual.prepare(input as never),
  "mca.annual.validate": (facade, input) => facade.mca.annual.validate(input as never),
  "mca.annual.export": (facade, input) => facade.mca.annual.export(input as never),
  "mca.annual.show": (facade, input) => facade.mca.annual.show(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "mca.annual.status": (facade, input) => facade.mca.annual.status(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "mca.annual.content": (facade, input) => facade.mca.annual.content(tenantId(input), bookSetId(input), text(input, "artifactId"), input.revealSensitive === true, input.actor && typeof input.actor === "object" ? String((input.actor as Record<string, unknown>).kind ?? "") : undefined),
  "mca.annual.package-status": (facade, input) => facade.mca.annual.packageStatus(tenantId(input), bookSetId(input), text(input, "financialYear")),
  ...
  "withholding.statement-schema-pack.register": (facade, input) => facade.withholdingStatement.schemaPack.register(input as never),
  "withholding.statement-schema-pack.verify": (facade, input) => facade.withholdingStatement.schemaPack.verify(input as never),
  "withholding.statement-schema-pack.reject": (facade, input) => facade.withholdingStatement.schemaPack.reject(input as never),
  "withholding.statement-schema-pack.show": (facade, input) => facade.withholdingStatement.schemaPack.show(text(input, "packId")),
  "withholding.statement-fact.propose": (facade, input) => facade.withholdingStatement.fact.propose(input as never),
  "withholding.statement-fact.confirm": (facade, input) => facade.withholdingStatement.fact.confirm(input as never),
  "withholding.statement-fact.reject": (facade, input) => facade.withholdingStatement.fact.reject(input as never),
  "withholding.statement-fact.list": (facade, input) => facade.withholdingStatement.fact.list(tenantId(input), bookSetId(input)),
  "withholding.statement.preview": (facade, input) => facade.withholdingStatement.statement.preview(tenantId(input), (input.payload ?? input) as never),
  "withholding.statement.prepare": (facade, input) => facade.withholdingStatement.statement.prepare(input as never),
  "withholding.statement.validate": (facade, input) => facade.withholdingStatement.statement.validate(input as never),
  "withholding.statement.export": (facade, input) => facade.withholdingStatement.statement.export(input as never),
  "withholding.statement.show": (facade, input) => facade.withholdingStatement.statement.show(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "withholding.statement.status": (facade, input) => facade.withholdingStatement.statement.status(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "withholding.statement.content": (facade, input) => facade.withholdingStatement.statement.content(tenantId(input), bookSetId(input), text(input, "artifactId"), input.revealSensitive === true, input.actor && typeof input.actor === "object" ? String((input.actor as Record<string, unknown>).kind ?? "") : undefined),
  ...
  "payroll.statutory-pack.register": (facade, input) => facade.payroll.statutory.pack.register(input as never),
  "payroll.statutory-pack.verify": (facade, input) => facade.payroll.statutory.pack.verify(input as never),
  "payroll.statutory-pack.reject": (facade, input) => facade.payroll.statutory.pack.reject(input as never),
  "payroll.statutory-pack.show": (facade, input) => facade.payroll.statutory.pack.show(text(input, "packId")),
  "payroll.statutory-artifact.preview": (facade, input) => facade.payroll.statutory.artifact.preview(tenantId(input), (input.payload ?? input) as never),
  "payroll.statutory-artifact.prepare": (facade, input) => facade.payroll.statutory.artifact.prepare(input as never),
  "payroll.statutory-artifact.validate": (facade, input) => facade.payroll.statutory.artifact.validate(input as never),
  "payroll.statutory-artifact.export": (facade, input) => facade.payroll.statutory.artifact.export(input as never),
  "payroll.statutory-artifact.show": (facade, input) => facade.payroll.statutory.artifact.show(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "payroll.statutory-artifact.status": (facade, input) => facade.payroll.statutory.artifact.status(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "payroll.statutory-artifact.content": (facade, input) => facade.payroll.statutory.artifact.content(tenantId(input), bookSetId(input), text(input, "artifactId"), input.revealSensitive === true, input.actor && typeof input.actor === "object" ? String((input.actor as Record<string, unknown>).kind ?? "") : undefined),
  "payroll.salary-tds.statement.preview": (facade, input) => facade.payroll.statutory.artifact.preview(tenantId(input), { ...((input.payload ?? input) as Record<string, unknown>), semanticKind: "SALARY_TDS_QUARTERLY_STATEMENT" } as never),
  "payroll.salary-tds.statement.prepare": (facade, input) => facade.payroll.statutory.artifact.prepare({ ...input, payload: { ...((input.payload ?? {}) as Record<string, unknown>), semanticKind: "SALARY_TDS_QUARTERLY_STATEMENT" } } as never),
  "payroll.salary-tds.statement.validate": (facade, input) => facade.payroll.statutory.artifact.validate(input as never),
  "payroll.salary-tds.statement.export": (facade, input) => facade.payroll.statutory.artifact.export(input as never),
  "payroll.salary-tds.statement.show": (facade, input) => facade.payroll.statutory.artifact.show(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "payroll.salary-tds.statement.status": (facade, input) => facade.payroll.statutory.artifact.status(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "payroll.salary-tds.certificate.preview": (facade, input) => facade.payroll.statutory.artifact.preview(tenantId(input), { ...((input.payload ?? input) as Record<string, unknown>), semanticKind: "SALARY_TDS_ANNUAL_CERTIFICATE" } as never),
  "payroll.salary-tds.certificate.prepare": (facade, input) => facade.payroll.statutory.artifact.prepare({ ...input, payload: { ...((input.payload ?? {}) as Record<string, unknown>), semanticKind: "SALARY_TDS_ANNUAL_CERTIFICATE" } } as never),
  "payroll.salary-tds.certificate.validate": (facade, input) => facade.payroll.statutory.artifact.validate(input as never),
  "payroll.salary-tds.certificate.export": (facade, input) => facade.payroll.statutory.artifact.export(input as never),
  "payroll.salary-tds.certificate.show": (facade, input) => facade.payroll.statutory.artifact.show(tenantId(input), bookSetId(input), text(input, "artifactId")),
  "payroll.salary-tds.certificate.status": (facade, input) => facade.payroll.statutory.artifact.status(tenantId(input), bookSetId(input), text(input, "artifactId")),
  ...
  "tax-case.source-assessment.prepare": (facade, input) => facade.taxCase.source.assessment.prepare(input as never),
  "tax-case.source-assessment.confirm": (facade, input) => facade.taxCase.source.assessment.confirm(input as never),
  "tax-case.source-assessment.reject": (facade, input) => facade.taxCase.source.assessment.reject(input as never),
  "tax-case.source-assessment.show": (facade, input) => facade.taxCase.source.assessment.show(tenantId(input), text(input, "taxCaseId"), text(input, "sourceId"), text(input, "assessmentId")),
