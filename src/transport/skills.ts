...
export const SKILL_GUIDES: readonly SkillGuide[] = [
  ...
  guide({
    ...
    steps: [
      ...
      op("source-staging.list", "Rediscover staged batches", "bookSet", "List bounded privacy-safe staging metadata newest first by createdAt then stagingId; use the returned stagingId for status."),
    ...
    nextDrilldowns: [{ title: "Rediscover staged sources", operationId: "source-staging.list" }, { title: "Inspect staged source", operationId: "source-staging.status" }],
  }),
  guide({
