...
async function fixture(): Promise<string> {
  ...
  await initializeSqliteDatabase(path, { cliVersion: "1.0.2", buildId: "test" });
  return path;
}
...
describe("Database Operations + Release CLI V1", () => {
  it("reports version and compatibility without implicit migration", async () => {
    ...
    expect(version).toMatchObject({ ok: true, result: { version: "1.0.2", protocolVersion: 1, supportedSchemaVersion: 8, updateChecks: "disabled" } });
